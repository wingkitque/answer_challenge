...
<head>
	...
	body{
            width: 100%;
            overflow: hidden;
            background: url("bg_feedback.jpg") no-repeat;
    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
				...
				<li class="active"><a href="admin_feedback.php">意见反馈</a></li>
...
<h1 style="text-align: center"><strong>意见反馈管理</strong></h1>
...
<table  width='100%' class="table table-hover">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $sql="select * from feedback where (value like '%{$keyword}%') ;";
    ...
    foreach ($res as $row){
        ...
        echo "<td><a href='admin_feedback_del.php?id={$row['id']}'>删除</a></td>";
        echo "</tr>";
		$index = $index + 1;
    };
    ?>
